...
Initial Setup
    ...
    Start Application: Run the script
    Click "Connect": Verify receiver is detected
    Click "Start Controller": Initialize the controller
    Sync Controller: Press the sync button on receiver, then on controller
    Calibrate: Don't touch sticks during calibration
...
D-Pad Modes
    Hold Mode (Default): Continuous mouse movement while held
    Click Mode: Each click moves mouse by step size
...
Controller Not Detected
    ...
    On Linux/macOS, check USB permissions
